#include <cstdlib>
#include "../include/compute_normf_6.h"

int main(int argc, char **argv) {
    compute_normf_6Handle_t handle;
    int Na = 42;
    int Nb = 42;
    int Nc = 42;
    ...
    handle = __dace_init_compute_normf_6(Na, Nb, Nc);
    __program_compute_normf_6(handle, F, __return, a, b, c, Na, Nb, Nc);
    __dace_exit_compute_normf_6(handle);
